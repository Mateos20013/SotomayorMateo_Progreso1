...
namespace SotomayorMateo_Progreso1.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(SotomayorMateo_Progreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Año,Precio,Disponible,PerezId")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Año,Precio,Disponible,PerezId")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
